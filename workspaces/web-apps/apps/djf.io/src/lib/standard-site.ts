...
export interface ExistingRecord {rkey: string; path?: string; site?: string}

export interface DesiredDocument {slug: string; path: string; record: Record<string, unknown>}
