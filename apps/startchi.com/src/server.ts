...
// workerd-native (no @sentry/node, so it sidesteps
// getsentry/sentry-javascript#20038); the client SDK is wired separately in
// src/observability. No-op until the SENTRY_DSN worker var is set. `main` in
// wrangler.toml points @cloudflare/vite-plugin at this wrapper instead of
// @tanstack/react-start/server-entry directly (cloudflare/workers-sdk#11100).
